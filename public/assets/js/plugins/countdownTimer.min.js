  ...
  function i(t, o) {
    ...
    window["hours_H" + n] === o.hours
      ? (v(t, (e = S(t, o, 0, 0, 0, window["hours_H" + n], 0, 0)), o),
        ...
        !0 === t.data("countdowntimer").destroy && h(t, "H", o))
      : (v(
          t,
          (e = S(
            t,
    ...
    window["seconds_M" + n] === o.seconds
      ? (v(t, (e = S(t, o, 0, 0, 0, 0, window["minutes_M" + n], 0)), o),
        ...
        0 !== window["minutes_M" + n]
          ? window["minutes_M" + n]--
          : h(t, "M", o),
        !0 === t.data("countdowntimer").destroy && h(t, "M", o))
      : (v(
          t,
          (e = S(
            t,
    ...
    window["minutes_HM" + n] === o.minutes && window["hours_HM" + n] === o.hours
      ? (v(
        ...
        0 === window["hours_HM" + n] &&
          ...
          h(t, "HM", o),
        !0 === t.data("countdowntimer").destroy && h(t, "HM", o))
      : (v(
          t,
          (e = S(
            t,
  ...
  function r(t, o) {
    ...
    window["seconds_MS" + n] === o.seconds
      ? (v(
        ...
        !0 === t.data("countdowntimer").destroy && h(t, "MS", o))
      : (v(
          t,
          (e = S(
            t,
  ...
  function a(t, o) {
    ...
    window["seconds_HS" + n] === o.seconds && window["hours_HS" + n] === o.hours
      ? (v(
        ...
        !0 === t.data("countdowntimer").destroy && h(t, "HS", o))
      : (v(
          t,
          (e = S(
            t,
  ...
  function u(t, o) {
    ...
    window["hours_HMS" + n] === o.hours
      ? (v(
        ...
        !0 === t.data("countdowntimer").destroy && h(t, "HMS", o))
      : (v(
          t,
          (e = S(
            t,
