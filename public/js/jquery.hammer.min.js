...
(function (t, e) {
  ...
  (i.event = {
    ...
    (i.utils = {
      ...
      getScale: function (t, e) {
        return t.length >= 2 && e.length >= 2
          ? this.getDistance(e[0], e[1]) / this.getDistance(t[0], t[1])
          : 1;
      },
          ...
          for (var r = 0; i.length > r; r++)
            for (var o in e)
              e.hasOwnProperty(o) &&
                ((n = o),
                i[r] &&
                  (n = i[r] + n.substring(0, 1).toUpperCase() + n.substring(1)),
                (t.style[n] = e[o]));
          "none" == e.userSelect &&
    ...
    (i.detection = {
      ...
      detect: function (t) {
        if (this.current && !this.stopped) {
          ...
          for (
            var e = this.current.inst.options, n = 0, r = this.gestures.length;
            r > n;
            n++
          ) {
      ...
      extendEventData: function (t) {
        ...
        if (
          e &&
          (t.touches.length != e.touches.length || t.touches === e.touches)
        ) {
          e.touches = [];
          ...
          switch (t.eventType) {
            ...
            case i.EVENT_MOVE:
              if (
                ...
                return;
              (i.detection.current.name = this.name),
                (i.detection.current.lastEvent.drag_locked_to_axis ||
                  (n.options.drag_lock_to_axis &&
                    n.options.drag_lock_min_distance <= t.distance)) &&
              ...
              t.drag_locked_to_axis &&
                ...
                (t.direction = i.utils.isVertical(r)
                  ...
                  : i.DIRECTION_RIGHT),
                this.triggered ||
                  (n.trigger(this.name + "start", t), (this.triggered = !0)),
    ...
    (i.gestures.Touch = {
      ...
      handler: function (t, n) {
        return n.options.prevent_mouseevents && t.pointerType == i.POINTER_MOUSE
          ? (t.stopDetect(), e)
      ...
      ((Hammer.event.bindDom = function (n, i, r) {
        t(n).on(i, function (t) {
          ...
          n.pageX === e && ((n.pageX = t.pageX), (n.pageY = t.pageY)),
            ...
            n.preventDefault || (n.preventDefault = t.preventDefault),
            n.stopPropagation || (n.stopPropagation = t.stopPropagation),
            r.call(this, n);
        });
      }),
