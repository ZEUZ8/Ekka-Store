!(function (n, h, u) {
  ...
  function r(t, e, i, s) {
    var o,
      ...
      a = "modernizr",
      l = p("div"),
      c = ((r = h.body) || ((r = p(v ? "svg" : "body")).fake = !0), r);
    if (parseInt(i, 10))
      for (; i--; )
        ((o = p("div")).id = s ? s[i] : a + (i + 1)), l.appendChild(o);
    return (
      ...
      r.styleSheet
        ...
        : r.appendChild(h.createTextNode(t)),
      (l.id = a),
      c.fake &&
        ((c.style.background = ""),
      ...
      (t = e(l, t)),
      c.fake
        ? (c.parentNode.removeChild(c), (g.style.overflow = n), g.offsetHeight)
  ...
  function f(t, e) {
    ...
    if ("CSS" in n && "supports" in n.CSS) {
      for (; i--; ) if (n.CSS.supports(o(t[i]), e)) return !0;
      return !1;
    }
    if ("CSSSupportsRule" in n) {
      for (var s = []; i--; ) s.push("(" + o(t[i]) + ":" + e + ")");
      return r(
        "@supports (" +
          (s = s.join(" or ")) +
        ...
        function (t) {
          return (
            ...
            (i = null),
            (s = "position"),
            "getComputedStyle" in n
              ? ((o = getComputedStyle.call(n, e, i)),
                (t = n.console),
                null !== o
                  ? s && (o = o.getPropertyValue(s))
                  : t &&
                    t[t.error ? "error" : "log"].call(
                      t,
                      "getComputedStyle returning null, its possible modernizr test results are inaccurate"
                    ))
              : (o = !i && e.currentStyle && e.currentStyle[s]),
            o)
          );
          var e, i, s, o;
        }
  ...
  function s(t, e, i, s, o) {
    ...
    return a(e, "string") || void 0 === e
      ? (function (t, e, i, s) {
          ...
          for (
            var r, a, l, c, h, d = ["modernizr", "tspan", "samp"];
            !C.style && d.length;

          )
            (r = !0), (C.modElem = p(d.shift())), (C.style = C.modElem.style);
          for (l = t.length, a = 0; a < l; a++)
            if (
              ...
              if (s || void 0 === i) return o(), "pfx" != e || c;
              try {
                C.style[c] = i;
              } catch (t) {}
              if (C.style[c] != h) return o(), "pfx" != e || c;
            }
          return o(), !1;
        })(r, e, s, o)
      : l((r = (t + " " + b.join(n + " ") + n).split(" ")), e, i);
  }
  function t(t, e, i) {
    return s(t, u, u, e, i);
  }
  var c = [],
    ...
    m = function () {};
  (m.prototype = e), (m = new m());
  var g = h.documentElement,
    v = "svg" === g.nodeName.toLowerCase(),
    i = "CSS" in n && "supports" in n.CSS,
    y = "supportsCSS" in n;
  m.addTest("supports", i || y);
  var y = "Moz O ms Webkit",
    _ = e._config.usePrefixes ? y.split(" ") : [];
  e._cssomPrefixes = _;
  var b = e._config.usePrefixes ? y.toLowerCase().split(" ") : [];
  e._domPrefixes = b;
  ...
  var x,
    $,
    C = { style: w.elem.style };
  m._q.unshift(function () {
    delete C.style;
  }),
    (e.testAllProps = s),
    (e.testAllProps = t),
    m.addTest("csstransforms3d", function () {
    ...
    (function () {
      ...
      for (r in d)
        if (d.hasOwnProperty(r)) {
          ...
          for (
            s = a(e.fn, "function") ? e.fn() : e.fn, o = 0;
            o < t.length;
            o++
          )
            1 === (n = t[o].split(".")).length
              ? (m[n[0]] = s)
              : (!m[n[0]] ||
                  m[n[0]] instanceof Boolean ||
                  (m[n[0]] = new Boolean(m[n[0]])),
                (m[n[0]][n[1]] = s)),
              c.push((s ? "" : "no-") + n.join("-"));
        }
    })(),
    ...
    m._config.enableJSClass &&
      ((y = new RegExp("(^|\\s)" + i + "no-js(\\s|$)")),
      ($ = $.replace(y, "$1" + i + "js$2"))),
    m._config.enableClasses &&
      (($ += " " + i + x.join(" " + i)),
      v ? (g.className.baseVal = $) : (g.className = $)),
    delete e.addTest,
    delete e.addAsyncTest;
  for (var k = 0; k < m._q.length; k++) m._q[k]();
  n.Modernizr = m;
})(window, document),
  (function (s) {
    "use strict";
            ...
            e
              ...
              .on("click", function () {
                s(this).next(".sub-menu").slideToggle(),
                  s(this).siblings("ul").addClass("open").slideToggle(),
                  s(this)
              ...
              .on("click", function () {
                s(this).next(".sub-menu").slideToggle(),
                  ...
                  s(this).siblings("ul").hasClass("open") &&
                    s(this).parents("li").eq(1).addClass("active");
              }))
          : e.addClass("dropdown"),
  ...
  (function (s) {
    "use strict";
    function n(t, e) {
      return classie.has(t, e) ? t : t.parentNode && n(t.parentNode, e);
    }
    function t(t, e, i) {
      (this.el = t),
        (this.trigger = e),
    ...
    (t.prototype = {
      ...
      _init: function () {
        ...
        var t,
          e,
          i = this;
        this.levels.forEach(function (t, e) {
          t.setAttribute(
            "data-level",
            (function t(e, i, s, o) {
              return (
                ...
                0 <= e.id.indexOf(i)
                  ? o
                  : (classie.has(e, s) && ++o,
                    e.parentNode && t(e.parentNode, i, s, o))
              );
            })(t, i.el.id, "mp-level")
          );
        }),
          ...
          (this.eventtype =
            ((e = !1),
            (t = navigator.userAgent || navigator.vendor || s.opera),
      ...
      _initEvents: function () {
        var o = this,
          e = function (t) {
            o._resetMenu(), t.removeEventListener(o.eventtype, e);
          };
        this.trigger.addEventListener(this.eventtype, function (t) {
          t.stopPropagation(),
            ...
            o.open
              ? o._resetMenu()
              : (o._openMenu(),
                document.addEventListener(o.eventtype, function (t) {
                  o.open &&
                    !(function (t, e) {
                      if (t) {
                        for (
          ...
          this.menuItems.forEach(function (i, t) {
            var s = i.querySelector("div.mp-level");
            s &&
              i.querySelector("a").addEventListener(o.eventtype, function (t) {
                t.preventDefault();
                var e = n(i, "mp-level").getAttribute("data-level");
                o.level <= e &&
                  (t.stopPropagation(),
                  classie.add(n(i, "mp-level"), "mp-level-overlay"),
                  o._openMenu(s));
              });
          }),
          this.levels.forEach(function (e, t) {
            e.addEventListener(o.eventtype, function (t) {
              t.stopPropagation();
              t = e.getAttribute("data-level");
              o.level > t && ((o.level = t), o._closeMenu());
            });
          }),
          this.levelBack.forEach(function (i, t) {
            i.addEventListener(o.eventtype, function (t) {
              t.preventDefault();
              var e = n(i, "mp-level").getAttribute("data-level");
              o.level <= e &&
                (t.stopPropagation(),
                (o.level = n(i, "mp-level").getAttribute("data-level") - 1),
                0 === o.level ? o._resetMenu() : o._closeMenu());
            });
          });
      },
      _openMenu: function (t) {
        ...
        var e = (this.level - 1) * this.options.levelSpacing,
          i =
            "overlap" === this.options.type
              ? this.el.offsetWidth + e
              : this.el.offsetWidth;
        if ((this._setTransform("translate3d(" + i + "px,0,0)"), t)) {
          this._setTransform("", t);
          for (var s = 0, o = this.levels.length; s < o; ++s) {
            var n = this.levels[s];
            n == t ||
              classie.has(n, "mp-level-open") ||
              this._setTransform(
                "translate3d(-100%,0,0) translate3d(" + -1 * e + "px,0,0)",
                n
              );
          }
        }
        1 === this.level &&
          ...
          classie.add(t || this.levels[0], "mp-level-open");
      },
      _resetMenu: function () {
      ...
      _closeMenu: function () {
        var t =
          "overlap" === this.options.type
            ...
            : this.el.offsetWidth;
        this._setTransform("translate3d(" + t + "px,0,0)"),
          this._toggleLevels();
      },
      _setTransform: function (t, e) {
        ((e = e || this.wrapper).style.WebkitTransform = t),
          (e.style.MozTransform = t),
          (e.style.transform = t);
      },
      _toggleLevels: function () {
        for (var t = 0, e = this.levels.length; t < e; ++t) {
          var i = this.levels[t];
          ...
          this.each(function () {
            ...
            s
              ...
              s
                ...
                .addClass(l.tabidentify),
              "vertical" == c &&
                s.addClass("resp-vtabs").addClass(l.tabidentify),
              1 == h && s.css({ width: "100%", margin: "0px" }),
              "accordion" == c &&
                (s.addClass("resp-easy-accordion").addClass(l.tabidentify),
            ...
            var r,
              a = 0;
            "" == u ||
              (null !== (r = u.match(new RegExp(o + "([0-9]+)"))) &&
                2 === r.length &&
                ((a = parseInt(r[1], 10) - 1), e < a && (a = 0))),
              f(s.find(".resp-tab-item." + l.tabidentify)[a])
                .addClass("resp-tab-active")
                .css({}),
              !0 === l.closed ||
                ("accordion" === l.closed && !t.is(":visible")) ||
                ("tabs" === l.closed && t.is(":visible")) ||
                (f(s.find(".resp-accordion." + l.tabidentify)[a])
                  .addClass("resp-tab-active")
                  .css({}),
                f(s.find(".resp-tab-content." + l.tabidentify)[a])
    ...
    (c.Defaults = {
      ...
      (c.prototype.to = function (t, e) {
        var i,
          ...
          l = this.maximum();
        this.settings.loop
          ? (!this.settings.rewind && Math.abs(o) > r / 2 && (o += -1 * n * r),
            (i = (((((t = s + o) - a) % r) + r) % r) + a) !== t &&
              i - o <= l &&
              0 < i - o &&
              ...
              if (
                ...
                for (
                  ...
                  this.load(n / 2 + this._core.relative(o)),
                    n && a.each(this._core.clones(this._core.relative(o)), r),
                    o++;
              }
            }, this),
        }),
  ...
  (function (h, e) {
    ...
    (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      ...
      (i.prototype.thumbnail = function (e, t) {
        ...
        if (
          (e.wrap(h("<div/>", { class: "owl-video-wrapper", style: n })),
    ...
    (i.Defaults = {
      ...
      (i.prototype.play = function (t, e) {
        ...
        this._core.is("rotating") || this._core.enter("rotating"),
          ...
          (this._timeout = t),
          (this._call = o.setTimeout(s.proxy(this._next, this, e), t - i));
      }),
      (i.prototype.stop = function () {
        this._core.is("rotating") &&
          ((this._time = 0),
  ...
  (function (s, o) {
    ...
    (e.Defaults = { URLhashListener: !1 }),
      (e.prototype.destroy = function () {
        var t, e;
        for (t in (s(o).off("hashchange.owl.navigation"), this._handlers))
          this._core.$element.off(t, this._handlers[t]);
        for (e in Object.getOwnPropertyNames(this))
          "function" != typeof this[e] && (this[e] = null);
      }),
        ...
        l.waypoint(
          function () {
            for (
              ...
              if ((o && (a = parseFloat((i / e) * r).toFixed(n)), s))
    ...
    (c.prototype = {
      ...
      _defineElements: function () {
        this.element === t.body && (this.element = o),
          ...
          (this.$element =
            this.element === o ? f("body") : this.$scrollElement),
          ...
          (this._setPosition =
            ...
            function (t, e, i, s, o) {
              n.options.horizontalScrolling && r.setLeft(t, e, i),
                n.options.verticalScrolling && r.setTop(t, s, o);
            });
      },
            ...
            this.$element.find("[data-stellar-ratio]").each(function (t) {
              ...
              p.options.showElement(l),
                ...
                p.particles.push({
                  ...
                  parentOffsetTop: h,
                  stellarRatio:
                    l.data("stellar-ratio") !== m ? l.data("stellar-ratio") : 1,
          ...
          this.options.parallaxBackgrounds &&
            ...
            t.each(function () {
              ...
              n.data("stellar-backgroundStartingLeft")
                ...
                : (n.data("stellar-backgroundStartingLeft", r[0]),
                  n.data("stellar-backgroundStartingTop", r[1])),
                (t =
                ...
                (t =
                  n.data("stellar-horizontal-offset") !== m
                    ? n.data("stellar-horizontal-offset")
                    : o !== m && o.data("stellar-horizontal-offset") !== m
                    ? o.data("stellar-horizontal-offset")
                    : d.horizontalOffset),
                (e =
                  n.data("stellar-vertical-offset") !== m
                    ? n.data("stellar-vertical-offset")
                    : o !== m && o.data("stellar-vertical-offset") !== m
                ...
                d.backgrounds.push({
                  ...
                  stellarRatio:
                    n.data("stellar-background-ratio") === m
                      ? 1
                      : n.data("stellar-background-ratio"),
                });
            }));
      },
      _reset: function () {
            ...
            (e = (t = this.particles[c]).isFixed ? 1 : 0),
              (a = this.options.horizontalScrolling
                ? (n =
                  ...
                  t.startingPositionLeft +
                  t.startingOffsetLeft
                : ((n = t.startingPositionLeft), t.startingOffsetLeft)),
        ...
        return e === m || "object" == typeof e
          ? this.each(function () {
              f.data(this, "plugin_" + s) ||
                f.data(this, "plugin_" + s, new c(this, e));
            })
          ...
          ? this.each(function () {
              ...
              t instanceof c &&
                ...
                "destroy" === e && f.data(this, "plugin_" + s, null);
            })
          : void 0;
      }),
      (f[s] = function (t) {
        ...
        (t = {
          ...
          for (n in this.waypoints[e]) {
            ...
            l.element !== l.element.window &&
              ...
              (h = !a && !c),
              !u && a && c
                ? (l.queueTrigger(r.backward), (o[l.group.id] = l.group))
                : ((!u && h) || (u && r.oldScroll >= l.triggerPoint)) &&
  ...
  (function (e) {
    ...
    var e,
      ...
      s =
        ((e = /msie\s\d+/i),
        0 < (t = t.userAgent).search(e) &&
          e.exec(t).toString().split(" ")[1] < 9 &&
        ...
        var n = o.call(arguments, 1),
          r = function () {
            if (this instanceof r) {
              ...
              var e = new t(),
                t = s.apply(e, n.concat(o.call(arguments)));
              return Object(t) === t ? t : e;
            }
            return s.apply(i, n.concat(o.call(arguments)));
          };
        return r;
      }),
    ...
    function o(t, e, i) {
      ...
      s))
        s.hasOwnProperty(o) && ((s[o] !== c && "" !== s[o]) || delete s[o]);
      i !== c &&
        "" !== i &&
        ((i = i.split(
        ...
        e && e.values && e.values.length
          ? ((t.from = i[0] && e.values.indexOf(i[0])),
            (t.to = i[1] && e.values.indexOf(i[1])))
          : ((t.from = i[0] && +i[0]), (t.to = i[1] && +i[1]))),
        r.extend(t, e),
        r.extend(t, s),
        (this.options = t),
        (this.update_check = {}),
    ...
    (o.prototype = {
            ...
            ("single" === this.options.type
              ...
              : ((n = t
                  ? (this.options.decorate_both
                      ? ((s = this.decorate(e[this.result.from])),
                        (s += this.options.values_separator),
                        (s += this.decorate(e[this.result.to])))
                      : (s = this.decorate(
                          e[this.result.from] +
                  ...
                  : ((n = this._prettify(this.result.from)),
                    ...
                    this.options.decorate_both
                      ? ((s = this.decorate(n, this.result.from)),
                        (s += this.options.values_separator),
                        (s += this.decorate(i, this.result.to)))
                      : (s = this.decorate(
                          n + this.options.values_separator + i,
                          this.result.to
                        )),
                    (o = this.decorate(n, this.result.from)),
      ...
      drawShadow: function () {
        ...
        "single" === i.type
          ...
          : (i.from_shadow && (o || n)
            ...
            i.to_shadow && (r || a)
              ? ((r = this.convertToPercent(r ? i.to_min : i.min)),
                (i = this.convertToPercent(a ? i.to_max : i.max) - r),
                (r = this.toFixed(r - (this.coords.p_handle / 100) * r)),
                (i = this.toFixed(i - (this.coords.p_handle / 100) * i)),
                (r += this.coords.p_handle / 2),
                (s.shad_to[0].style.display = "block"),
                (s.shad_to[0].style.left = r + "%"),
      ...
      convertToPercent: function (t, e) {
        var i = this.options.max - this.options.min,
          s = i / 100;
        return i
          ? ((s = (e ? t : t - this.options.min) / s), this.toFixed(s))
      ...
      convertToValue: function (t) {
        ...
        return (
          l && (t -= l),
          (t = s ? +t.toFixed(s.length) : this.toFixed(t)) < this.options.min
            ? (t = this.options.min)
      ...
      checkMinInterval: function (t, e, i) {
        ...
        return o.min_interval
          ? ((s = this.convertToValue(t)),
            ...
            "from" === i
              ? e - s < o.min_interval && (s = e - o.min_interval)
              : s - e < o.min_interval && (s = e + o.min_interval),
      ...
      checkMaxInterval: function (t, e, i) {
        ...
        return o.max_interval
          ? ((s = this.convertToValue(t)),
            (e = this.convertToValue(e)),
            "from" === i
              ? e - s > o.max_interval && (s = e - o.max_interval)
              : s - e > o.max_interval && (s = e + o.max_interval),
            this.convertToPercent(s))
          : t;
      },
      checkDiapason: function (t, e, i) {
        var s = this.convertToValue(t),
          t = this.options;
        return (
          "number" != typeof e && (e = t.min),
          "number" != typeof i && (i = t.max),
          s < e && (s = e),
          i < s && (s = i),
          this.convertToPercent(s)
        );
          ...
          for (
            ...
            (d +=
              ...
              (d +=
                ...
                c +
                '%">' +
                (n = r.values.length ? r.p_values[n] : this._prettify(n)) +
                "</span>");
          }
      ...
      calcGridCollision: function (t, e, i) {
        for (
          var s, o, n = this.coords.big_num, r = 0;
          r < n && !(n <= (s = r + t / 2));
          r += t
        )
      ...
      (r.fn.ionRangeSlider = function (t) {
        return this.each(function () {
          r.data(this, "ionRangeSlider") ||
            r.data(this, "ionRangeSlider", new o(this, t, i++));
        });
      }),
      (function () {
        for (
          var n = 0, t = ["ms", "moz", "webkit", "o"], e = 0;
          e < t.length && !l.requestAnimationFrame;
          ++e
        )
          (l.requestAnimationFrame = l[t[e] + "RequestAnimationFrame"]),
            (l.cancelAnimationFrame =
              l[t[e] + "CancelAnimationFrame"] ||
              l[t[e] + "CancelRequestAnimationFrame"]);
  ...
  (function (t) {
    ...
    (t.prototype = {
        ...
        if (!f.isOpen) {
          ...
          u("BeforeOpen"),
            ...
            f.fixedContentPos
              ...
              : f.wrap.css({ top: x.scrollTop(), position: "absolute" }),
            (!1 !== f.st.fixedBgPos &&
          ...
          return (
            ...
            setTimeout(function () {
              f.content
                ? (f._addClassToMFP(w), f._setFocus())
                : f.bgOverlay.addClass(w),
      ...
      _openClick: function (t, e, i) {
        if (
          ...
          var s = (void 0 !== i.disableOn ? i : c.magnificPopup.defaults)
            .disableOn;
          if (s)
            if (c.isFunction(s)) {
          ...
          "string" == typeof t
            ? "open" === t
              ? ((e = a ? o.data("magnificPopup") : o[0].magnificPopup),
                ...
                (s = e.items
                  ? e.items[i]
                  : ((s = o), e.delegate && (s = s.find(e.delegate)), s.eq(i))),
                f._openClick({ mfpEl: s }, o, e))
              : f.isOpen &&
                f[t].apply(f, Array.prototype.slice.call(arguments, 1))
            : ((t = c.extend(!0, {}, t)),
              a ? o.data("magnificPopup", t) : (o[0].magnificPopup = t),
              f.addGroup(o, t)),
          o
        );
      });
          ...
          if (($(), t.src)) {
            ...
            return (
              o.length
                ? ((i = o[0].parentNode) &&
                    i.tagName &&
                    (k || ((C = s.hiddenClass), (k = d(C)), (C = "mfp-" + C)),
                    (T = o.after(k).detach().removeClass(C))),
                  f.updateStatus("ready"))
                : (f.updateStatus("error", s.tNotFound), (o = c("<div>"))),
              (t.inlineElement = o)
            );
          }
        ...
        getImage: function (t, e) {
          ...
          return (
            a.length &&
              ...
              (t.img = c(i).on("load.mfploader", o).on("error.mfploader", n)),
              (i.src = t.src),
    ...
    c.magnificPopup.registerModule("zoom", {
      ...
      proto: {
          ...
          r.enabled &&
            ...
            (o = function (t) {
              var e = t
                ...
                t = "transition";
              return (
                (s["-webkit-" + t] = s["-moz-" + t] = s["-o-" + t] = s[t] = i),
                e.css(s),
                e
              );
            }),
        ...
        _getOffset: function (t) {
          ...
          s = {
            width: e.width(),
            height: (a ? e.innerHeight() : e[0].offsetHeight) - t - s,
          };
          return (
            void 0 === O &&
    ...
    function M(t) {
      var e;
      !f.currTemplate[I] ||
        ((e = f.currTemplate[I].find("iframe")).length &&
          ...
          return (
            ...
            !(!n || !n.enabled) &&
              ...
              h("UpdateStatus" + t, function (t, e) {
                e.text &&
                  (e.text = j(e.text, f.currItem.index, f.items.length));
              }),
              h(y + t, function (t, e, i, s) {
                var o = f.items.length;
                i.counter = 1 < o ? j(n.tCounter, s.index, o) : "";
              }),
              h("BuildControls" + t, function () {
                ...
                1 < f.items.length &&
                  ...
                  (t = f.arrowLeft =
                    c(
                      e.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")
                    ).addClass(r)),
                  (e = f.arrowRight =
                    c(
                      e
      ...
      (e.prototype.init = function () {
          ...
          this.s.dynamic
            ...
            : ((o = i.attr("data-sub-html")),
              this.s.getCaptionFromTitleOrAlt &&
                !o &&
                (o = i.attr("title") || i.find("img").first().attr("alt"))),
            e ||
              (null != o
                ? ("." !== (s = o.substring(0, 1)) && "#" !== s) ||
                  (o = (
        ...
        (e.prototype.loadContent = function (e, t, i) {
          ...
          c.s.dynamic
            ...
            : "true" === c.$items.eq(e).attr("data-iframe") && (d = !0);
          var p = c.isVideo(a, e);
          if (!c.$slide.eq(e).hasClass("lg-loaded")) {
            if (
              ...
              u && s.attr("sizes", u),
              n && (s.attr("srcset", n), this.s.supportLegacyBrowser))
            )
              try {
          ...
          c.$slide
            ...
            p && p.html5 && !h && c.$slide.eq(e).addClass("lg-complete"),
            !0 === t &&
            ...
            h.lgBusy ||
              (this.s.download &&
                ((r = h.s.dynamic
                  ? !1 !== h.s.dynamicEl[t].downloadUrl &&
                    (h.s.dynamicEl[t].downloadUrl || h.s.dynamicEl[t].src)
                  : "false" !== h.$items.eq(t).attr("data-download-url") &&
                    (h.$items.eq(t).attr("data-download-url") ||
              ...
              e
                ? (this.$slide.removeClass(
                  ...
                  "prev" === s
                    ...
                    : h.$slide.eq(a).addClass("lg-prev-slide"),
              ...
              h.lGalleryOn
                ? (setTimeout(function () {
                  ...
                  setTimeout(function () {
                    (h.lgBusy = !1),
                      h.$el.trigger("onAfterSlide.lg", [c, t, e, i]);
                  }, this.s.speed))
        ...
        (e.prototype.enableDrag = function () {
          ...
          e.s.enableDrag &&
            ...
            f(window).on("mouseup.lg", function (t) {
              n
                ? ((n = !1), e.touchEnd(s - i), e.$el.trigger("onDragend.lg"))
        ...
        (t.prototype.build = function () {
          ...
          if (
            ...
            o.core.s.animateThumb &&
              o.core.$outer
                .find(".lg-thumb")
                .css({ width: o.thumbTotalWidth + "px", position: "relative" }),
            this.core.s.animateThumb &&
              o.$thumbOuter.css("height", o.core.s.thumbContHeight + "px"),
            o.core.s.dynamic)
          )
            for (var i = 0; i < o.core.s.dynamicEl.length; i++)
              e(o.core.s.dynamicEl[i].src, o.core.s.dynamicEl[i].thumb, i);
          else
          ...
          o.core.$outer.find(".lg-thumb").html(n),
            ...
            t.on("click.lg touchend.lg", function () {
              var t = a(this);
              setTimeout(function () {
                ((!o.thumbClickable || o.core.lgBusy) && o.core.doCss()) ||
          ...
          e.core.$outer.find(".lg-thumb").on("touchstart.lg", function (t) {
            ...
            e.core.$outer.find(".lg-thumb").on("touchmove.lg", function (t) {
              e.thumbTotalWidth > e.thumbOuterWidth &&
                ...
                e.$thumbOuter.addClass("lg-dragging"),
                (n = e.left),
                (n -= s - i) > e.thumbTotalWidth - e.thumbOuterWidth &&
          ...
          function (t, e, i, s) {
            ...
            if (
              ...
              if (o.core.s.videojs)
                try {
                  videojs(
                    o.core.$slide.eq(e).find(".lg-html5").get(0),
                ...
                !o.videoLoaded &&
                  o.core.s.autoplayFirstVideo &&
                  o.core.$slide.eq(e).find(".lg-html5").get(0).play();
          }.bind(this)
        ),
          s.core.$el.on(
          ...
          var n = this,
            ...
            n = n.core.s.dynamic
              ...
              : n.core.$items.eq(n.core.index).attr("title") ||
                n.core.$items.eq(n.core.index).find("img").first().attr("alt");
          return (
            (n = n ? 'title="' + n + '"' : ""),
            i &&
              ...
              o = function (t, e) {
                if (
                  ...
                  if (s.core.s.videojs)
                    try {
                      videojs(
                        s.core.$slide.eq(s.core.index).find(".lg-html5").get(0),
    ...
    !(function () {
      ...
      (t.prototype.init = function () {
        ...
        n.core.s.actualSize &&
          ...
          n.core.$el.on("onSlideItemLoad.lg.tm.zoom", function (t, e, i) {
        ...
        function s(t, e, i, s) {
          var o = e.prop("offsetWidth"),
            e = n.core.s.dynamic
              ? n.core.s.dynamicEl[i].width || e[0].naturalWidth || o
          ...
          n.core.$outer.hasClass("lg-zoomed")
            ...
            s
              ? ((n.pageX = u(window).width() / 2),
                (n.pageY = u(window).height() / 2 + u(window).scrollTop()))
              : ((n.pageX = t.pageX || t.originalEvent.targetTouches[0].pageX),
                (n.pageY = t.pageY || t.originalEvent.targetTouches[0].pageY)),
            r(),
            setTimeout(function () {
        ...
        (t.prototype.zoomSwipe = function () {
          ...
          o.core.$slide.on("touchstart.lg", function (t) {
            ...
            o.core.$outer.hasClass("lg-zoomed") &&
              ((e = o.core.$slide.eq(o.core.index).find(".lg-object")),
              (s = o.core.$slide.eq(o.core.index).find(".lg-img-rotate")[0]),
              (h = o.getCurrentRotation(s)),
              (e = o.getDragAllowedAxises(e, Math.abs(h))),
              (c = e.allowY),
              ((l = e.allowX) || c) &&
                (t.preventDefault(), (n = o.getSwipeCords(t, Math.abs(h)))));
          }),
            o.core.$slide.on("touchmove.lg", function (t) {
              var e, i;
              o.core.$outer.hasClass("lg-zoomed") &&
                ((e = o.core.$slide.eq(o.core.index).find(".lg-img-wrap")),
                t.preventDefault(),
                (a = !0),
                ...
                (t = l
                  ...
                  : -Math.abs(e.attr("data-x"))),
                (15 < Math.abs(r.x - n.x) || 15 < Math.abs(r.y - n.y)) &&
        ...
        (t.prototype.touchendZoom = function (t, e, i, s, o) {
          ...
          (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) &&
            (s &&
              (l <= -o.maxY ? (l = -o.maxY) : l >= -o.minY && (l = -o.minY)),
            i && (c <= -o.maxX ? (c = -o.maxX) : c >= -o.minX && (c = -o.minX)),
            s
  ...
  (function (t) {
    ...
    function e(t) {
      ...
      if (
        ...
        "axis" in i && i.axis === i.HORIZONTAL_AXIS && ((n = -1 * r), (r = 0)),
        (o = 0 === r ? n : r),
    ...
    function u(t, e) {
      return (
        g.settings.adjustOldDeltas && "mousewheel" === t.type && e % 120 == 0
      );
    }
    var p,
      f,
    ...
    if (h.event.fixHooks)
      for (var s = t.length; s; ) h.event.fixHooks[t[--s]] = h.event.mouseHooks;
              ...
              off: function (t, e) {
                ...
                if (s && e)
                  for (var n = 0, r = s.length; n < r; n++)
                    s[n].fn !== e && s[n].fn._ !== e && o.push(s[n]);
      ...
      E = {
        ...
        util: {
          encode: function (t) {
            return t instanceof P
              ? new P(t.type, E.util.encode(t.content), t.alias)
              : Array.isArray(t)
              ? t.map(E.util.encode)
              : t
                  .replace(/&/g, "&amp;")
          ...
          clone: function i(t, s) {
            ...
            switch (((s = s || {}), n)) {
              case "Object":
                if (((e = E.util.objId(t)), s[e])) return s[e];
                for (var r in ((o = {}), (s[e] = o), t))
                  t.hasOwnProperty(r) && (o[r] = i(t[r], s));
                return o;
              case "Array":
                return (
                  (e = E.util.objId(t)),
        ...
        languages: {
          ...
          insertBefore: function (i, t, e, s) {
            ...
            return (
              (s[i] = r),
              E.languages.DFS(E.languages, function (t, e) {
                e === l && t != i && (this[t] = r);
              }),
              r
            );
          },
          DFS: function t(e, i, s, o) {
            o = o || {};
            var n,
              r,
              a,
            ...
            for (n in e)
              e.hasOwnProperty(n) &&
                (i.call(e, n, e[n], s || n),
                (r = e[n]),
                "Object" !== (a = E.util.type(r)) || o[l(r)]
                  ? "Array" !== a || o[l(r)] || ((o[l(r)] = !0), t(r, i, n, o))
                  : ((o[l(r)] = !0), t(r, i, null, o)));
          },
        },
        plugins: {},
        ...
        highlightAllUnder: function (t, e, i) {
          ...
          E.hooks.run("before-highlightall", s);
          for (
            var o, n = s.elements || t.querySelectorAll(s.selector), r = 0;
            (o = n[r++]);

          )
            E.highlightElement(o, !0 === e, s.callback);
        },
        highlightElement: function (t, e, i) {
          for (var s, o = "none", n = t; n && !c.test(n.className); )
            n = n.parentNode;
          n &&
            ((o = (n.className.match(c) || [, "none"])[1].toLowerCase()),
            (s = E.languages[o])),
            (t.className =
            ...
            t.parentNode &&
              ...
              /pre/i.test(n.nodeName) &&
                (n.className =
                  n.className.replace(c, "").replace(/\s+/g, " ") +
                  " language-" +
                  o));
          function r(t) {
            (a.highlightedCode = t),
              E.hooks.run("before-insert", a),
              (a.element.innerHTML = a.highlightedCode),
              E.hooks.run("after-highlight", a),
              E.hooks.run("complete", a),
              i && i.call(a.element);
          }
          var a = { element: t, language: o, grammar: s, code: t.textContent };
          E.hooks.run("before-sanity-check", a),
            a.code
              ? (E.hooks.run("before-highlight", a),
                a.grammar
                  ? e && l.Worker
                    ? (((e = new Worker(E.filename)).onmessage = function (t) {
                        r(t.data);
                      }),
                      e.postMessage(
                        JSON.stringify({
                    ...
                    : r(E.highlight(a.code, a.grammar, a.language))
                  : r(E.util.encode(a.code)))
              : E.hooks.run("complete", a);
        },
        highlight: function (t, e, i) {
          ...
          return (
            ...
            P.stringify(E.util.encode(i.tokens), i.language)
          );
        },
        matchGrammar: function (t, e, i, s, o, n, r) {
          for (var a in i)
            if (i.hasOwnProperty(a) && i[a]) {
              if (a == r) return;
              for (
                var l = i[a], l = "Array" === E.util.type(l) ? l : [l], c = 0;
                c < l.length;
                ++c
              ) {
                var h,
                ...
                f &&
                  !d.pattern.global &&
                  ((h = d.pattern.toString().match(/[imuy]*$/)[0]),
                  (d.pattern = RegExp(d.pattern.source, h + "g"))),
                  (d = d.pattern || d);
                for (var v = s, y = o; v < e.length; y += e[v].length, ++v) {
                  var _ = e[v];
                  if (e.length > t.length) return;
                  if (!(_ instanceof P)) {
                    if (f && v != e.length - 1) {
                      if (((d.lastIndex = y), !(k = d.exec(t)))) break;
                      for (
                        var b = k.index + (p ? k[1].length : 0),
                          w = k.index + k[0].length,
                          x = v,
                          $ = y,
                          C = e.length;
                        x < C && ($ < w || (!e[x].type && !e[x - 1].greedy));
                        ++x
                      )
                        ($ += e[x].length) <= b && (++v, (y = $));
                      if (e[v] instanceof P) continue;
                      (T = x - v), (_ = t.slice(y, $)), (k.index -= y);
                    } else {
                      d.lastIndex = 0;
                      var k = d.exec(_),
                        T = 1;
                    ...
                    if (k) {
                      p && (m = k[1] ? k[1].length : 0),
                        (w = (b = k.index + m) + (k = k[0].slice(m)).length);
                      var S = _.slice(0, b),
                        z = _.slice(w),
                        _ = [v, T];
                      S && (++v, (y += S.length), _.push(S));
                      S = new P(a, u ? E.tokenize(k, u) : k, g, k, f);
                      if (
                        (_.push(S),
                        z && _.push(z),
                        Array.prototype.splice.apply(e, _),
                        1 != T && E.matchGrammar(t, e, i, v, y, !0, a),
                        n)
                      )
                        break;
                    } else if (n) break;
        ...
        hooks: {
          ...
          run: function (t, e) {
            var i = E.hooks.all[t];
            if (i && i.length) for (var s, o = 0; (s = i[o++]); ) s(e);
          },
        },
        Token: P,
      };
            ...
            l.addEventListener(
              ...
              function (t) {
                var e = JSON.parse(t.data),
                  ...
                  t = e.code,
                  e = e.immediateClose;
                l.postMessage(E.highlight(t, E.languages[i], i)),
                  e && l.close();
              },
              !1
            )),
